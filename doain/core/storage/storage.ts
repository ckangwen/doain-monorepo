...
interface StorageOptions {
  prefix?: string;
  storage: IStorage;
  expireTime?: NonNullable<DoainClientConfig["app"]["expireTime"]>;
}
...
class StorageLike {
  ...
  constructor(options: StorageOptions) {
    ...
    this.expireTimeConfig = options.expireTime || DEFAULT_CACHE_TIME;
  }
...
export const lStorage = new StorageLike({
  ...
  prefix: userDoainConfig.app.storageKey || userDoainConfig.app.appKey || "",
  expireTime: userDoainConfig.app.expireTime || DEFAULT_CACHE_TIME,
});
